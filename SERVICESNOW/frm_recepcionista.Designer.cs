namespace SERVICESNOW
{
    partial class frm_recepcionista
    {
        ...
        private void InitializeComponent()
        {
            ...
            pbc_user.Location = new Point(1596, 3);
            ...
            // pnl_consultas
            // 
            pnl_consultas.Controls.Add(pbcHorarios_modificar);
            ...
            // pnl_reservas
            // 
            pnl_reservas.Controls.Add(pbcSalones_modificar);
            pnl_reservas.Controls.Add(pbc_Saloneseliminar);
            pnl_reservas.Controls.Add(pbc_Salonesagregar);
            pnl_reservas.Dock = DockStyle.Top;
            pnl_reservas.Location = new Point(0, 175);
            pnl_reservas.Name = "pnl_reservas";
            pnl_reservas.Size = new Size(250, 137);
            pnl_reservas.TabIndex = 5;
            // 
            ...
            // pbc_reservas
            // 
            pbc_reservas.Dock = DockStyle.Top;
            pbc_reservas.Image = Properties.Resources.img_reservas1;
            pbc_reservas.Location = new Point(0, 125);
            pbc_reservas.Name = "pbc_reservas";
            pbc_reservas.Size = new Size(250, 50);
            pbc_reservas.SizeMode = PictureBoxSizeMode.StretchImage;
            pbc_reservas.TabIndex = 4;
            pbc_reservas.TabStop = false;
            pbc_reservas.Click += pbc_reservas_Click;
            // 
            // pnl_logo1
            // 
            ...
            // pnl_formularios
            // 
            pnl_formularios.BackColor = Color.White;
            pnl_formularios.Location = new Point(261, 110);
            pnl_formularios.Name = "pnl_formularios";
            pnl_formularios.Size = new Size(1652, 835);
            pnl_formularios.TabIndex = 2;
            // 
            // pbc_cerrarsesion
            // 
            pbc_cerrarsesion.BackColor = Color.FromArgb(92, 64, 51);
            pbc_cerrarsesion.Image = Properties.Resources.img_elisesion;
            pbc_cerrarsesion.Location = new Point(1596, 60);
            ...
            Controls.Add(pnl_formularios);
            Controls.Add(pnl_menu);
            Controls.Add(pnl_superior);
            Name = "frm_recepcionista";
            Text = " ";
            Load += frm_recepcionista_Load;
